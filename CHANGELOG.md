...
- **The heartbeat took three intervals to declare a link stale, not the two documented.** The counter was compared before it was incremented, so at the default the detection window was ~90 s where 60 s was intended. The node now probes immediately on authenticating and counts before comparing; measured at a 1 s interval, detection went from 2.998 s to 2.009 s.
